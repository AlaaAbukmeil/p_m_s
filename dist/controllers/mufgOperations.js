...
exports.createExcelAndReturnPath = exports.formatFxTradesToMufg = exports.formatBBGBlotToMufg = exports.readFxTrades = exports.readBBE = exports.readIB = exports.readBBGBlot = void 0;
...
async function formatBBGBlotToMufg(files) {
    ...
    for (let index = 0; index < bbbData.length; index++) {
        ...
        if (trade["Status"] == "Accepted") {
            ...
            obj["Trade_ID_Client"] = parseAndFormat(trade["Triada Trade Id"], (0, common_1.convertExcelDateToJSDate)(trade["Trade Date"]));
            ...
            obj["Trade_Date"] = (0, common_2.getTradeDateYearTrades)((0, common_1.convertExcelDateToJSDate)(trade["Trade Date"]));
            obj["Settle_Date"] = (0, common_2.getTradeDateYearTrades)(settlementDate);
            obj["Expiration_Date"] = "";
            obj["Strike"] = "";
            obj["Put_Call"] = "";
    ...
    for (let index2 = 0; index2 < ibData.length; index2++) {
        ...
        if (trade["Header"] == "Data") {
            ...
            obj["Trade_ID_Client"] = parseAndFormat(`Triada-IB-${(0, common_1.getDateMufg)(tradeDate)}-${counter}`, (0, common_2.getTradeDateYearTrades)((0, common_1.getDateMufg)((0, common_1.convertExcelDateToJSDate)(trade["Date/Time"]))));
            ...
            obj["Currency_Investment"] = "";
            obj["Trade_Date"] = (0, common_2.getTradeDateYearTrades)((0, common_1.getDateMufg)((0, common_1.convertExcelDateToJSDate)(trade["Date/Time"])));
            obj["Settle_Date"] = (0, common_2.getTradeDateYearTrades)((0, common_1.getDateMufg)((0, common_1.convertExcelDateToJSDate)(trade["Date/Time"])));
            obj["Expiration_Date"] = "";
            obj["Strike"] = "";
            obj["Put_Call"] = "";
    ...
    for (let index3 = 0; index3 < bbeData.length; index3++) {
        ...
        let tradeDate = (0, common_1.convertBBGEmexDate)(trade["Create Time (As of)"]);
        let originalFace = 1;
        obj["File_Type"] = "ExchSec";
        obj["Fund"] = "90104";
        obj["Transaction_Event"] = "N";
        ...
        obj["Trade_ID_Client"] = parseAndFormat(`Triada-EMSX-${(0, common_1.getDateMufg)(tradeDate)}-${counter}`, (0, common_1.convertBBGEmexDate)((0, common_1.convertExcelDateToJSDate)(trade["Create Time (As of)"])));
        ...
        obj["Currency_Investment"] = "";
        obj["Trade_Date"] = (0, common_1.convertBBGEmexDate)((0, common_1.convertExcelDateToJSDate)(trade["Create Time (As of)"]));
        obj["Settle_Date"] = (0, common_1.convertBBGEmexDate)((0, common_1.convertExcelDateToJSDate)(trade["Create Time (As of)"]));
        obj["Expiration_Date"] = "";
        obj["Strike"] = "";
        obj["Put_Call"] = "";
        obj["Custodian_Account_Client"] = "NOM_PB";
...
exports.formatBBGBlotToMufg = formatBBGBlotToMufg;
...
function parseAndFormat(str, inputDate) {
