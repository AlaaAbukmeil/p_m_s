...
exports.createExcelAndReturnPath = exports.formatFxTradesToMufg = exports.formatFxMufg = exports.formatMufg = exports.readFxTrades = exports.readBBE = exports.readIB = exports.readBBGBlot = void 0;
...
async function formatMufg(files, tradesCount) {
    ...
    for (let fileIndex = 0; fileIndex < files.length; fileIndex++) {
        ...
        if (file["fieldname"] == "BBB") {
            ...
            ibData = await (0, portfolioFunctions_1.readIBEblot)(path);
        }
        else if (file["fieldname"] == "BBE") {
            let path = "https://storage.googleapis.com/capital-trade-396911.appspot.com" + file["filename"];
            bbeData = await (0, portfolioFunctions_2.readEmsxEBlot)(path);
        }
    }
    let mufg = [];
    ...
    for (let index2 = 0; index2 < ibData.length; index2++) {
        ...
        let obj = {};
        let triadaId = `${parseAndFormat((0, common_2.getTradeDateYearTrades)((0, common_1.getDateMufg)(trade["Trade Date"])))}` + (counter < 10 ? "0" + counter : counter);
        ...
        obj["Currency_Investment"] = "";
        obj["Trade_Date"] = (0, common_2.getTradeDateYearTrades)((0, common_1.getDateMufg)(trade["Trade Date"]));
        obj["Settle_Date"] = (0, common_2.getTradeDateYearTrades)((0, common_1.getDateMufg)(trade["Settle Date"]));
        obj["Expiration_Date"] = "";
        obj["Strike"] = "";
        obj["Put_Call"] = "";
