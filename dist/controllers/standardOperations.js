...
exports.readTriadaEBlot = exports.getReport = exports.insertEBlotTransactions = exports.generateImagineEBlot = exports.uploadToGCloudBucket = exports.readBloombergSheet = void 0;
...
async function readBloombergSheet(path, inputTrader, inputStrategy) {
...
exports.readBloombergSheet = readBloombergSheet;
...
async function generateImagineEBlot(arr) {
...
exports.generateImagineEBlot = generateImagineEBlot;
...
async function readTriadaEBlot(path) {
    const response = await axios.get(path, { responseType: 'arraybuffer' });
    /* Parse the data */
    const workbook = xlsx.read(response.data, { type: 'buffer' });
    /* Get first worksheet */
...
exports.readTriadaEBlot = readTriadaEBlot;
