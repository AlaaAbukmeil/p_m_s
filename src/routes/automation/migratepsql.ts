...
import { formatPositionsTOSQL } from "../../controllers/db/convert";
...
//   for (let index = 175; index < finalCollectionsArray.length; index++) {
...
//     /// formatPositionsTOSQL need to change date to number
