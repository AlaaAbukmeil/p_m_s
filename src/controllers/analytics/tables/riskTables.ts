...
export function sumTable({ table, data, view, param, subtotal, subtotalParam }: { table: any; data: any; view: "front office" | "back office" | "exposure"; param: any; subtotal: boolean; subtotalParam: string }) {
  try {
    ...
    let cr01DollarValueImpact = parseFloat(data["CR01 Dollar Value Impact"]);

    let cr01DollarValueOfNav = parsePercentage(data["CR01 Dollar Value Impact % of Nav"]);
    let cr01DollarValueLimitOfNav = parsePercentage(data["CR01 Dollar Value Impact Limit % of Nav"]);
    let cr01DollarValueLimitUtilization = parsePercentage(data["CR01 Dollar Value Impact Utilization % of Nav"]);
    let cr01DollarValueImpactTest = data["CR01 Dollar Value Impact Test"];
    ...
    let cr01 = parseFloat(data["CR01"]) || 0;
    ...
    table[param + " Aggregated"]["CR01"] += cr01;
    ...
    if (dv01DollarValueImpactTest == "Fail") {
      ...
      // table[param + " Aggregated"]["DV01 Dollar Value Impact Test Color"] = "#FFAB91"; // : "#FFAB91";
    }

    table[param + " Aggregated"]["CR01 Dollar Value Impact"] += cr01DollarValueImpact;
    table[param + " Aggregated"]["CR01 Dollar Value Impact % of Nav"] += cr01DollarValueOfNav;
    table[param + " Aggregated"]["CR01 Dollar Value Impact Limit % of Nav"] += cr01DollarValueLimitOfNav;
    table[param + " Aggregated"]["CR01 Dollar Value Impact Utilization % of Nav"] += cr01DollarValueLimitUtilization;

    if (cr01DollarValueImpactTest == "Fail") {
      table[param + " Aggregated"]["CR01 Dollar Value Impact Test"] = "Fail";
      // table[param + " Aggregated"]["DV01 Dollar Value Impact Test Color"] = "#FFAB91"; // : "#FFAB91";
    }
    ...
    if (valueUSDOfNavTest == "Fail") {
      ...
      // table[param + " Aggregated"]["Value (BC) Test Color"] = "#FFAB91";
    }
    ...
    if (dv01DollarValueImpactTest == "Fail") {
      ...
      // table["Total"]["DV01 Dollar Value Impact Test Color"] = "#FFAB91"; // : "#FFAB91";
    }

    table["Total"] = table["Total"] ? table["Total"] : new AggregatedData();
    table["Total"]["CR01 Dollar Value Impact"] += cr01DollarValueImpact;
    table["Total"]["CR01 Dollar Value Impact % of Nav"] += cr01DollarValueOfNav;
    table["Total"]["CR01 Dollar Value Impact Limit % of Nav"] += cr01DollarValueLimitOfNav;
    table["Total"]["CR01 Dollar Value Impact Utilization % of Nav"] += cr01DollarValueLimitUtilization;

    if (cr01DollarValueImpactTest == "Fail") {
      table["Total"]["CR01 Dollar Value Impact Test"] = "Fail";
      // table["Total"]["DV01 Dollar Value Impact Test Color"] = "#FFAB91"; // : "#FFAB91";
    }
    ...
    if (valueUSDOfNavTest == "Fail") {
      ...
      // table["Total"]["Value (BC) Test Color"] = "#FFAB91";
    }
    ...
    table["Total"]["OAS W Change"] += oasWChangeSum;
    ...
    if (subtotal) {
      ...
      table[subtotalParam]["CR01 Dollar Value Impact"] += cr01DollarValueImpact;
      table[subtotalParam]["CR01 Dollar Value Impact % of Nav"] += Math.round(cr01DollarValueOfNav * 100) / 100 || 0;
      table[subtotalParam]["CR01 Dollar Value Impact Limit % of Nav"] += cr01DollarValueLimitOfNav;
      table[subtotalParam]["CR01 Dollar Value Impact Utilization % of Nav"] += cr01DollarValueLimitUtilization;
      ...
      table[subtotalParam][strategy]["CR01 Dollar Value Impact"] += cr01DollarValueImpact;
      table[subtotalParam][strategy]["CR01 Dollar Value Impact % of Nav"] += Math.round(cr01DollarValueOfNav * 100) / 100 || 0;
      table[subtotalParam][strategy]["CR01 Dollar Value Impact Limit % of Nav"] += cr01DollarValueLimitOfNav;
      table[subtotalParam][strategy]["CR01 Dollar Value Impact Utilization % of Nav"] += cr01DollarValueLimitUtilization;
      ...
      table[subtotalParam][strategy]["CR01"] += cr01;
