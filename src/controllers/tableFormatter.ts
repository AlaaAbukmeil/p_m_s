...
export function formatFrontEndTable(portfolio: any, date: any) {
  let currencies: any = {};
...
export function formatFrontEndRiskReport(portfolio: any, pairPositionIds: any) {
  let tableTitles = [
    "#",
...
export function formatSummaryPosition(position: any, fundDetails: any) {
...
export function formatFrontEndSummaryTable(portfolio: any, date: any, nav: number, holdbackRatio: number) {
  let currencies: any = {};
  let formatted = [];
  let mtdpl = 0,
    mtdrlzd = 0,
